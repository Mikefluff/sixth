...
a hypergraph rewriting engine with 23 substrate primitives, 60 demos
...
- 867 ✓ across 60 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=867 fail=0`. Single-
