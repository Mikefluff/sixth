...
a hypergraph rewriting engine with 23 substrate primitives, 86 demos
...
- 1180 ✓ across 86 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=1180 fail=0`. Single-
