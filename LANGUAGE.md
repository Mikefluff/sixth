...
a hypergraph rewriting engine with 23 substrate primitives, 84 demos
...
- 1140 ✓ across 84 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=1140 fail=0`. Single-
