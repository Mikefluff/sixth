...
a hypergraph rewriting engine with 23 substrate primitives, 76 demos
...
- 1049 ✓ across 76 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=1049 fail=0`. Single-
