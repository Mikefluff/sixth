...
a hypergraph rewriting engine with 23 substrate primitives, 78 demos
...
- 1081 ✓ across 78 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=1081 fail=0`. Single-
