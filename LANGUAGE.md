...
a hypergraph rewriting engine with 23 substrate primitives, 50 demos
...
- 707 ✓ across 50 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=707 fail=0`. Single-
