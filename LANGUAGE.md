...
a hypergraph rewriting engine with 23 substrate primitives, 81 demos
...
- 1117 ✓ across 81 demos. The regression gate
  (`tests/examples-test.rkt`) enforces `pass=1117 fail=0`. Single-
