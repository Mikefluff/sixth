...
@bold{Status:} engine + stdlib + 86 demos (sacred hello world +
...
conservation + Pilot K spontaneous coalition assembly, 1180 ✓) + @litchar{#lang sixth} + Racket-FFI PyTorch bridges
