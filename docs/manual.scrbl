...
@bold{Status:} engine + stdlib + 84 demos (sacred hello world +
...
conservation + Pilot K spontaneous coalition assembly, 1140 ✓) + @litchar{#lang sixth} + Racket-FFI PyTorch bridges
