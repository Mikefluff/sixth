...
@bold{Status:} engine + stdlib + 60 demos (sacred hello world +
Pilots A--I + 3 substrate-monism trace pilots + 2 long-epoch
...
multi-level particle hierarchy, 867 ✓) + @litchar{#lang sixth} + Racket-FFI PyTorch bridges
